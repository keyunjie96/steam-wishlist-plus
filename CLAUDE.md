...
│   ├── options.tsx         # Options page UI (Preact)
│   ├── options.html        # Options page HTML shell
│   ├── components/         # Shared Preact components
│   │   ├── Toggle.tsx      # Toggle switch (mini/full variants)
│   │   ├── StatBox.tsx     # Stat display box
│   │   ├── StatusMessage.tsx # Auto-hiding status messages
│   │   ├── Section.tsx     # Collapsible section container
│   │   └── IconButton.tsx  # Button with loading state
│   └── styles.css          # Extension styles
├── dist/                   # Compiled JavaScript (generated by esbuild)
│   └── preact-vendor.js    # Shared Preact runtime bundle
├── tests/                  # Test files
