...
│   ├── components/          # Lit shared UI components
│   │   ├── swp-theme.ts      # Shared Lit theme variables
│   │   ├── swp-toggle.ts     # Toggle switch component
│   │   ├── swp-stat-box.ts   # Stat display component
│   │   ├── swp-status-message.ts # Status message component
│   │   ├── swp-section.ts    # Collapsible section component
│   │   └── swp-icon-button.ts # Icon button component
│   ├── icons.ts            # Icon definitions
│   ├── types.ts            # Type definitions
│   ├── popup.ts            # Popup Lit component
│   ├── popup.html          # Popup HTML shell
│   ├── options.ts          # Options Lit component
