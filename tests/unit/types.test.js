...
describe('types.js', () => {
  ...
  describe('StoreUrls', () => {
    it('should export StoreUrls to globalThis', () => {
      ...
      expect(typeof globalThis.SWP_StoreUrls).toBe('object');
    });
    ...
    describe('export fallback', () => {
      it('should fall back to window when globalThis is undefined', () => {
        ...
        const savedStoreUrls = globalThis.SWP_StoreUrls;
        ...
        expect(globalThis.SWP_StoreUrls || window.SWP_StoreUrls).toBeDefined();

        // Restore
        globalThis.SWP_StoreUrls = savedStoreUrls;
      });

      it('should not overwrite existing SWP_StoreUrls', () => {
        // Save original values
        const savedStoreUrls = globalThis.SWP_StoreUrls;

        // Set a mock value
        const mockStoreUrls = { nintendo: () => 'mock', playstation: () => 'mock', xbox: () => 'mock' };
        globalThis.SWP_StoreUrls = mockStoreUrls;
        ...
        expect(globalThis.SWP_StoreUrls).toBe(mockStoreUrls);
  ...
  describe('UserSettings', () => {
    it('should export SWP_UserSettings to globalThis', () => {
      expect(globalThis.SWP_UserSettings).toBeDefined();
      expect(typeof globalThis.SWP_UserSettings).toBe('object');
    });
    ...
    it('should have SETTING_CHECKBOX_IDS for all settings', () => {
      const { SETTING_CHECKBOX_IDS } = globalThis.SWP_UserSettings;
    ...
    it('should have USER_SETTING_KEYS array with all setting keys', () => {
      const { USER_SETTING_KEYS } = globalThis.SWP_UserSettings;
    ...
    it('should not overwrite existing SWP_UserSettings', () => {
      // Save original values
      const savedUserSettings = globalThis.SWP_UserSettings;

      // Set a mock value
      const mockUserSettings = { test: true };
      globalThis.SWP_UserSettings = mockUserSettings;
      ...
      // Verify the existing value was not overwritten
      expect(globalThis.SWP_UserSettings).toBe(mockUserSettings);

      // Restore
      globalThis.SWP_UserSettings = savedUserSettings;
    });
  });
});
