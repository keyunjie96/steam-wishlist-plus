...
describe('resolver.js', () => {
  ...
  beforeEach(() => {
    ...
    globalThis.SWP_WikidataClient = mockWikidataClient;
  ...
  afterEach(() => {
    ...
    delete globalThis.SWP_WikidataClient;
    delete globalThis.SWP_StoreUrls;
    delete globalThis.SWP_ProtonDBClient;
  ...
  describe('exports', () => {
    it('should export SWP_Resolver to globalThis', () => {
      expect(globalThis.SWP_Resolver).toBeDefined();
      expect(typeof globalThis.SWP_Resolver).toBe('object');
    });
