...
describe('wikidataClient.js', () => {
  ...
  describe('exports', () => {
    it('should export SWP_WikidataClient to globalThis', () => {
      expect(globalThis.SWP_WikidataClient).toBeDefined();
      expect(typeof globalThis.SWP_WikidataClient).toBe('object');
    });

    it('should export all required functions', () => {
      const Client = globalThis.SWP_WikidataClient;
  ...
  describe('STORE_URL_BUILDERS', () => {
    it('should have builders for all supported stores', () => {
      const builders = globalThis.SWP_WikidataClient.STORE_URL_BUILDERS;
  ...
  describe('PLATFORM_QIDS', () => {
    it('should have QID for Nintendo Switch', () => {
      const qids = globalThis.SWP_WikidataClient.PLATFORM_QIDS;
